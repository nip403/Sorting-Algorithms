...
class Show_array:
    ...
    def get_speed_colour(self, length):
        return [255 if (length/10 if length/10 <= 100 else 100) > 50 else int(((length/10 if length/10 <= 100 else 100) * 2) * 2.55), 255 if (length/10 if length/10 <= 100 else 100) < 50 else int(255 - ((length/10 if length/10 <= 100 else 100)*2 - 100) * 2.55), 0]
